...
io.on('connect', function(socket) {
	...
	socket.on('takePicture', function() {
		...
		NodeWebcam.capture('public/'+imageName, opts, function( err, data ) {
			...
			var fileName = 'public/'+imageName+'.jpg';
			var imageCaption = 'Hello, Sunny Ladkani! This can be a poster, if you had time!';
			var loadedImage;
			...
			nodemailer.createTestAccount((err, account) => {
				let transporter = nodemailer.createTransport({
					...
					auth: {
						user: 'sunny.ladkani3', //Gmail username
						pass: '$Kavita937124' // Gmail password
					}
				});

				let mailOptions = {
					from: '"Sunny Ladkani" <sunny.ladkani3@gmail.com>',
					to: 'sunny.ladkani@gmail.com', // Recepient email address. Multiple emails can send separated by commas
					subject: 'Here is your picture!',
					text: 'Hi there, this is the picture you clicked',
					html: 'Embedded image: <img src="cid:sunny.ladkani3@gmail.com"/>',
					attachments: [{
						filename: 'image.png',
						path: 'public/'+imageName + '.jpg',
						cid: 'sunny.ladkani3@gmail.com' //same cid value as in the html img src
					}]
				};
